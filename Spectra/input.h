...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_1_Hayley-Planet_phase_136.8_inc_0.00.00.0"      /* output name */
#define T_P_3D_FILE "DATA/init_Hayley-Planet_phase_136.8_inc_0.0.txt"         /* input file */
...
#define NLAMBDA 4616                       /* Number of wavelength points in grid [4616/2598]   */
...
#define INPUT_PHASE 136.8              /* Planet inclination in degrees           */
#define G 6.83                             /* Planet surface gravity                 */

#define R_PLANET 131000000.0                 /* Planet radius at base of atmosphere      */
#define ORB_SEP 4940000000.0                  // This is some distance
#define STELLAR_TEMP 6250                // Stellar Blackbody temperature
#define R_STAR 1204000000.0                    /* Stellar radius                         */
#define P_ROT  1.81                        /* Rotation period in days (= P_ORB for tidally locked planet)    */
