...
/* File names */
#define OUTPUT_PREFIX "OUT/Spec_0_Multi-Wavelength_phase_180.0_inc_0.00.00.0"      /* output name */
#define T_P_3D_FILE "DATA/init_Multi-Wavelength_phase_180.0_inc_0.0.txt"         /* input file */
